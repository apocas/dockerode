...
/**
 * Check if a container exists or not.
 * @param  {Function} callback Callback
 */
Container.prototype.exists = function(callback) {
  var self = this;

  if(callback === undefined) {
    return new this.modem.Promise(function(resolve) {
      self.inspect(function(err, data) {
        if (err || !data) {
    ...
    this.inspect(function(err, data) {
      if (err || !data) {
