...
/**
 * Inspect
 * @param  {[String]} version Optional version to specify a single image version
 * @param  {Function} callback Callback, if specified Docker will be queried.
 * @return {Object}            Name only if callback isn't specified.
 */
Image.prototype.inspect = function(version, callback) {
  ...
  if (typeof callback === 'function') {
    var opts = {
      path: '/images/' + this.name + (version ? ': version' : '') + '/json',
      method: 'GET',
      statusCodes: {
        200: true,
        404: 'no such image',
