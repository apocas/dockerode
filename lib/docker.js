 ...
 * Remove a network
 * 
 * @see https://docs.docker.com/engine/api/v1.33/#operation/NetworkDelete
 * 
 * @param {Object}   opts     Remove options
 * @param {String}   opts.id  Id or name of network to remove
 * @param {Function} callback Callback
 */
Docker.prototype.removeNetwork = function(opts, callback) {
  var self = this;
  var args = util.processArgs(opts, callback);
  var optsf = {
    path: `/networks/${args.opts.id}`,
    method: 'DELETE',
    statusCodes: {
      204: true,
  ...
  if (args.callback === undefined) {
    ...
    this.modem.dial(optsf, function(err) {
