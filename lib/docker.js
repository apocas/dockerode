...
Docker.prototype.createContainer = function(opts, callback) {
  ...
  return new Promise(function(resolve, reject){
    this.modem.dial(optsf, function(err, data) {
      if (err) return callback ? callback(err, data) : reject(err);
      callback ? callback(err, self.getContainer(data.Id)) : resolve(data.Id);
    });
  }.bind(this));
};
...
Docker.prototype.loadImage = function(file, opts, callback) {
  ...
  return new Promise(function(resolve, reject){
    this.modem.dial(optsf, function(err, data) {
      if(err && !callback) return reject(err);
      callback ? callback(err, data) : resolve(err);
    });
  }.bind(this))
};
...
Docker.prototype.createVolume = function(opts, callback) {
  ...
  return new Promise(function(resolve, reject){
    this.modem.dial(optsf, function(err, data) {
      ...
      args.callback ? args.callback(err, self.getVolume(data.Name)) : resolve(self.getVolume(data.Name));
    });
  }.bind(this));
};
...
Docker.prototype.createNetwork = function(opts, callback) {
  ...
  return new Promise(function(resolve, reject){
    this.modem.dial(optsf, function(err, data) {
      if (err) return args.callback ? args.callback(err, data) : reject(err);
      args.callback ? args.callback(err, self.getNetwork(data.Id)) : resolve(self.getNetwork(data.Id));
    });
  }.bind(this));
};
